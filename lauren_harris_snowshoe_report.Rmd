...
**Figure 3.** Relationship of hind foot length (mm) and body weight (g) of juvenile hares from Bonanza Creek Experimental Forest LTER site (`r min(juvenile_hares$year)`-`r max(juvenile_hares$year)`). Points indicate individual observations. Linear model summary: $\beta_1$ = `r round(juv_hares_lm$coefficients[2], 2)` g/mm, p < 0.001, R$^2$ = `r round(summary(juv_hares_lm)$r.squared, 2)`, Pearson's r = `r round(juv_hares_cor$estimate, 2)`)
